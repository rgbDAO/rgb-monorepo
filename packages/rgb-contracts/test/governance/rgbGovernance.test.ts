...
import { RgbToken, RgbDescriptor__factory as RgbDescriptorFactory } from '../../typechain';
...
describe('Rgb Governance', () => {
  let snapshotId: number;
  let token: RgbToken;
  let tokenCallFromGuy: RgbToken;
  let tokenCallFromDeployer: RgbToken;
  ...
  before(async () => {
    ...
    domain = Domain('Rgb', token.address, await chainId());
