...
/// @title The rgbDAO proxy contract
...
// LICENSE
// RgbDAOProxy.sol is a modified version of Compound Lab's GovernorBravoDelegator.sol:
...
//
//
// RgbDAOProxy.sol uses parts of Open Zeppelin's Proxy.sol:
...
contract RgbDAOProxy is RgbDAOProxyStorage, RgbDAOEvents {
    constructor(
        address timelock_,
        address rgb_,
        address vetoer_,
    ...
    function _setImplementation(address implementation_) public {
        require(msg.sender == admin, 'RgbDAOProxy::_setImplementation: admin only');
        require(implementation_ != address(0), 'RgbDAOProxy::_setImplementation: invalid implementation address');
